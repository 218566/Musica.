...
if($polaczenie->connect_errno!=0) {
    ...
    $sql = "SELECT * FROM critic WHERE user_id='1' AND track='Stainless'";
    $sql2 = "SELECT * FROM critic WHERE user_id='1' AND track='bigos'";
    ...
    if ($request = $polaczenie->query(($sql2))) {
...
<li><a href="about.html">albumy</a></li>
<li><a href="track.php">utwory</a></li>
<li><a href="#">osoby<i class="ti-angle-down"></i></a>
<ul class="submenu">
<li><a href="elements.html">Bartek</a></li>
<li><a href="elements.html">Karolina</a></li>
</ul>
</li>
...
<div class="thumb">
<img src="img/music_man/stainless.png" alt="">
</div>
<div class="audio_name">
<div class="name">
 <h4><?php echo $track;?></h4>
 <p>27-01-2020</p>
</div>
                ...
                <div class="col-xl-10">
                    <div class="row align-items-center">
                                <div class="col-xl-9 col-md-9">
                                    <div class="music_field">
                                            <div class="thumb">
                                                    <img src="img/music_man/bigos.png" alt="">
                                                </div>
                                                <div class="audio_name">
                                                    <div class="name">
                                                        <h4><?php echo $track2;?></h4>
                                                        <p>27-01-2020</p>
                                                    </div>
                                                        <audio preload="auto" controls>
                                                                <source src="https://www.w3schools.com/html/horse.mp3">
